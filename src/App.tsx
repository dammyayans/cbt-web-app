...
import LecturerLogin from 'src/pages/lecturerRoutes/login';
import DashboardHome from 'src/pages/lecturerRoutes/dashboard';
import LCourses from 'src/pages/lecturerRoutes/courses';
...
import Settings from 'src/pages/lecturerRoutes/settings';
import CourseDetailsL from 'src/pages/lecturerRoutes/courseDetails';
